...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react34.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
function useForceUpdate() {
  var _useReducer = (0, import_react35.useReducer)(function(state) {
    return !state;
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react36.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
function useMediaQuery(query, targetWindow) {
  ...
  var _useState = (0, import_react69.useState)(function() {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react70.useMemo)(function() {
